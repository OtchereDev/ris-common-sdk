...
func (x *GetStaffRequest) GetOrganizationId() uint32 {
	if x != nil {
		return x.OrganizationId
	}
	return 0
...
const file_appointment_proto_rawDesc = "" +
	"\n" +
	"\x11appointment.proto\x12\x05proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x0ereferral.proto\x1a\rpatient.proto\x1a\rportals.proto\"\xfa\a\n" +
