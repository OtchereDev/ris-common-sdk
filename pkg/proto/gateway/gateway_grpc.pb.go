...
const (
	StudyService_VerifyStudy_FullMethodName = "/proto.StudyService/VerifyStudy"
)
...
type StudyServiceClient interface {
	VerifyStudy(ctx context.Context, in *VerifyStudyRequest, opts ...grpc.CallOption) (*VerifyStudyResponse, error)
}
...
func (c *studyServiceClient) VerifyStudy(ctx context.Context, in *VerifyStudyRequest, opts ...grpc.CallOption) (*VerifyStudyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifyStudyResponse)
	err := c.cc.Invoke(ctx, StudyService_VerifyStudy_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StudyServiceServer interface {
	VerifyStudy(context.Context, *VerifyStudyRequest) (*VerifyStudyResponse, error)
...
func (UnimplementedStudyServiceServer) VerifyStudy(context.Context, *VerifyStudyRequest) (*VerifyStudyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VerifyStudy not implemented")
}
...
func _StudyService_VerifyStudy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyStudyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StudyServiceServer).VerifyStudy(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StudyService_VerifyStudy_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudyServiceServer).VerifyStudy(ctx, req.(*VerifyStudyRequest))
	}
...
var StudyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.StudyService",
	HandlerType: (*StudyServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "VerifyStudy",
			Handler:    _StudyService_VerifyStudy_Handler,
		},
	},
