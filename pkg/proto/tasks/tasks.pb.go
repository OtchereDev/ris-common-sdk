...
type TaskNotification struct {
	...
	UserId           uint32                 `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                              // Recipient
	NotificationType string                 `protobuf:"bytes,3,opt,name=notification_type,json=notificationType,proto3" json:"notification_type,omitempty"` // task_assigned, deadline_approaching, etc.
	...
	SendEmail     bool   `protobuf:"varint,13,opt,name=send_email,json=sendEmail,proto3" json:"send_email,omitempty"`
	SendInApp     bool   `protobuf:"varint,14,opt,name=send_in_app,json=sendInApp,proto3" json:"send_in_app,omitempty"`
...
type DailySummary struct {
	...
	TotalInProgress int32                  `protobuf:"varint,5,opt,name=total_in_progress,json=totalInProgress,proto3" json:"total_in_progress,omitempty"`
	UrgentCount     int32                  `protobuf:"varint,6,opt,name=urgent_count,json=urgentCount,proto3" json:"urgent_count,omitempty"`
	...
	Tasks           []*TaskSummaryItem     `protobuf:"bytes,9,rep,name=tasks,proto3" json:"tasks,omitempty"`
	// Delivery preferences
	SendEmail     bool `protobuf:"varint,10,opt,name=send_email,json=sendEmail,proto3" json:"send_email,omitempty"`
	SendInApp     bool `protobuf:"varint,11,opt,name=send_in_app,json=sendInApp,proto3" json:"send_in_app,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DailySummary) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
func (x *DailySummary) GetTotalPending() int32 {
	if x != nil {
...
func (x *DailySummary) GetTotalInProgress() int32 {
	if x != nil {
...
func (x *DailySummary) GetTasks() []*TaskSummaryItem {
	if x != nil {
		return x.Tasks
	}
	return nil
...
type TaskEscalation struct {
	...
	PatientName    string                 `protobuf:"bytes,3,opt,name=patient_name,json=patientName,proto3" json:"patient_name,omitempty"`
	Modality       string                 `protobuf:"bytes,4,opt,name=modality,proto3" json:"modality,omitempty"`
	AssignedTo     uint32                 `protobuf:"varint,5,opt,name=assigned_to,json=assignedTo,proto3" json:"assigned_to,omitempty"`
	AssignedToName string                 `protobuf:"bytes,6,opt,name=assigned_to_name,json=assignedToName,proto3" json:"assigned_to_name,omitempty"`
...
func (x *TaskEscalation) GetAssignedTo() uint32 {
	if x != nil {
		return x.AssignedTo
	}
	return 0
...
func (x *TaskEscalation) GetAssignedToName() string {
	if x != nil {
...
func (x *TaskEscalation) GetDueDate() *timestamp.Timestamp {
	if x != nil {
		return x.DueDate
	}
	return nil
...
const file_pkg_proto_tasks_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\x83\x04\n" +
	...
	"\fdays_overdue\x18\v \x01(\x05R\vdaysOverdue\x12\x1a\n" +
	"\bpriority\x18\f \x01(\tR\bpriority\x12\x1d\n" +
	"\n" +
	"send_email\x18\r \x01(\bR\tsendEmail\x12\x1e\n" +
	"\vsend_in_app\x18\x0e \x01(\bR\tsendInApp\x12#\n" +
	"\remail_address\x18\x0f \x01(\tR\femailAddress\"\x97\x03\n" +
	...
	"\x11total_in_progress\x18\x05 \x01(\x05R\x0ftotalInProgress\x12!\n" +
	"\furgent_count\x18\x06 \x01(\x05R\vurgentCount\x12&\n" +
	"\x0fdue_today_count\x18\a \x01(\x05R\rdueTodayCount\x12#\n" +
	"\roverdue_count\x18\b \x01(\x05R\foverdueCount\x12,\n" +
	"\x05tasks\x18\t \x03(\v2\x16.tasks.TaskSummaryItemR\x05tasks\x12\x1d\n" +
	"\n" +
	"send_email\x18\n" +
	" \x01(\bR\tsendEmail\x12\x1e\n" +
	"\vsend_in_app\x18\v \x01(\bR\tsendInApp\"\xf9\x01\n" +
	...
	"\x05stage\x18\a \x01(\tR\x05stage\"\xd0\x02\n" +
	"\x0eTaskEscalation\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12%\n" +
	"\x0eappointment_id\x18\x02 \x01(\rR\rappointmentId\x12!\n" +
	"\fpatient_name\x18\x03 \x01(\tR\vpatientName\x12\x1a\n" +
	"\bmodality\x18\x04 \x01(\tR\bmodality\x12\x1f\n" +
	"\vassigned_to\x18\x05 \x01(\rR\n" +
	"assignedTo\x12(\n" +
	"\x10assigned_to_name\x18\x06 \x01(\tR\x0eassignedToName\x12!\n" +
	"\fdays_overdue\x18\a \x01(\x05R\vdaysOverdue\x125\n" +
	"\bdue_date\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\adueDate\x12\x1a\n" +
	"\bpriority\x18\t \x01(\tR\bpriority\"\xbb\x02\n" +
...
var file_pkg_proto_tasks_proto_depIdxs = []int32{
	...
	6,  // 11: tasks.DailySummary.tasks:type_name -> tasks.TaskSummaryItem
	9,  // 12: tasks.TaskSummaryItem.due_date:type_name -> google.protobuf.Timestamp
	9,  // 13: tasks.TaskEscalation.due_date:type_name -> google.protobuf.Timestamp
	9,  // 14: tasks.InAppNotification.read_at:type_name -> google.protobuf.Timestamp
	9,  // 15: tasks.InAppNotification.created_at:type_name -> google.protobuf.Timestamp
