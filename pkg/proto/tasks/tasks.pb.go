...
func (x *TaskAttachment) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *TaskHistory) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
type TaskNotification struct {
	...
	RecipientName string `protobuf:"bytes,18,opt,name=recipient_name,json=recipientName,proto3" json:"recipient_name,omitempty"` // Display name of the email recipient, for the greeting
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TaskNotification) GetDueDate() *timestamppb.Timestamp {
	if x != nil {
		return x.DueDate
	}
	return nil
...
func (x *TaskNotification) GetDeadline() *timestamppb.Timestamp {
	if x != nil {
		return x.Deadline
	}
	return nil
...
func (x *TaskNotification) GetRecipientName() string {
	if x != nil {
...
type DailySummary struct {
	...
	SummaryDate   *timestamppb.Timestamp `protobuf:"bytes,15,opt,name=summary_date,json=summaryDate,proto3" json:"summary_date,omitempty"`
	RecipientName string                 `protobuf:"bytes,16,opt,name=recipient_name,json=recipientName,proto3" json:"recipient_name,omitempty"` // Display name of the email recipient, for the greeting
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DailySummary) GetSummaryDate() *timestamppb.Timestamp {
	if x != nil {
...
func (x *DailySummary) GetRecipientName() string {
	if x != nil {
		return x.RecipientName
	}
	return ""
...
func (x *TaskSummaryItem) GetDueDate() *timestamppb.Timestamp {
	if x != nil {
		return x.DueDate
	}
	return nil
...
type TaskEscalation struct {
	...
	SendInApp     bool   `protobuf:"varint,13,opt,name=send_in_app,json=sendInApp,proto3" json:"send_in_app,omitempty"`
	EmailAddress  string `protobuf:"bytes,14,opt,name=email_address,json=emailAddress,proto3" json:"email_address,omitempty"`
	RecipientName string `protobuf:"bytes,15,opt,name=recipient_name,json=recipientName,proto3" json:"recipient_name,omitempty"` // Display name of the email recipient, for the greeting
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TaskEscalation) GetDeadline() *timestamppb.Timestamp {
	if x != nil {
		return x.Deadline
	}
	return nil
...
func (x *TaskEscalation) GetRecipientName() string {
	if x != nil {
		return x.RecipientName
	}
	return ""
...
const file_pkg_proto_tasks_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\x8a\x05\n" +
	...
	"\remail_address\x18\x11 \x01(\tR\femailAddress\x12%\n" +
	"\x0erecipient_name\x18\x12 \x01(\tR\rrecipientName\"\xbd\x04\n" +
	...
	"\fsummary_date\x18\x0f \x01(\v2\x1a.google.protobuf.TimestampR\vsummaryDate\x12%\n" +
	"\x0erecipient_name\x18\x10 \x01(\tR\rrecipientName\"\xf9\x01\n" +
	...
	"\x05stage\x18\a \x01(\tR\x05stage\"\x81\x04\n" +
	...
	"\vsend_in_app\x18\r \x01(\bR\tsendInApp\x12#\n" +
	"\remail_address\x18\x0e \x01(\tR\femailAddress\x12%\n" +
	"\x0erecipient_name\x18\x0f \x01(\tR\rrecipientName\"\xbb\x02\n" +
