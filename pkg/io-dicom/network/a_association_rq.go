...
type AAssociationRQ interface {
	...
	GetCallingHost() string
	GetCallingPort() int
	SetCallingHost(host string)
	SetCallingPort(port int)
}
...
func (aarq *aassociationRQ) GetCallingHost() string {
	return aarq.callingHost
}

func (aarq *aassociationRQ) GetCallingPort() int {
	return aarq.callingPort
}

func (aarq *aassociationRQ) SetCallingHost(host string) {
	aarq.callingHost = host
}

func (aarq *aassociationRQ) SetCallingPort(port int) {
	aarq.callingPort = port
}
